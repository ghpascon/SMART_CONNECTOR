...
class ManageDevices:
        ...
        try:
            ...
            if self.connect_task and not self.connect_task.done():
                try:
                    ...
                    logging.warning("⏰ Timeout ao aguardar loop de conexão, cancelando forcosamente")
    ...
    async def update_device(self, data, name="default", path="config/devices"):
        ...
        if self._updating:
            return {"error": "Sistema em processo de atualização, tente novamente em alguns segundos"}
